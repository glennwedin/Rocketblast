...
export default (game = {
    ...
    canvas: {
        ...
        clearContext: function() {
            BOOM.canvas.ctx.clearRect(
                0,
                0,
                BOOM.settings.width,
                BOOM.settings.height
            );
        }
    },
    ...
    main: function() {
        ...
        th.animFrame = window.requestAnimationFrame(th.main);
    },

    //new level - gjenbrukbar funksjon

    init: function(showInitDialog = true) {
                ...
                dialog(
                    {
                        title: 'Get ready!',
                        text:
                            'You are called on to save new years eve. Your mission is to make sure all the rockets go off as planned.',
                        action_yes: 'Go',
                        action_next: null,
